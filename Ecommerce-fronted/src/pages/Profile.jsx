            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-24 h-24 mb-6 rounded-full bg-linear-to-tr from-slate-100 to-slate-200 flex items-center justify-center border border-white shadow-inner">
                <span className="text-2xl font-light text-slate-400">
                  <img src="https://i.pinimg.com/736x/73/8f/dd/738fdd8972bbd52f6c8bdffda75588ef.jpg" alt="profilr" className="rounded-full"/>{/* {data?.username?.charAt(0).toUpperCase()} */}
                </span>
              </div>
              ...
              <div className="w-full space-y-3">
                <Link to="/edit">
                  <button className="w-full py-3 bg-white border border-slate-200 text-slate-900 text-sm font-medium rounded-2xl hover:bg-slate-50 transition-all active:scale-[0.98] mb-5">
                    Edit Profile
                  </button>
                </Link>
